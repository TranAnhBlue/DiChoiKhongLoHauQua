...
export const SAMPLE_LOCATIONS = [
  ...
  // ===== HÒA LẠC, HÀ NỘI (KHU CÔNG NGHỆ CAO) =====

  // QUÁN CAFE KHU VỰC HÒA LẠC
  {
    name: "The Coffee House - FPT University",
    description: "Quán cafe hiện đại trong khuôn viên Đại học FPT, WiFi tốc độ cao, không gian học tập lý tưởng",
    category: LOCATION_CATEGORIES.CAFE,
    latitude: 21.0128,
    longitude: 105.5265,
    address: "Khuôn viên Đại học FPT, Khu Công nghệ cao Hòa Lạc, Thạch Thất, Hà Nội",
    phone: "024 7300 1313",
    website: "https://thecoffeehouse.com",
    imageUrl: "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=800",
    amenities: ["WiFi miễn phí", "Ổ cắm điện", "Không gian học tập", "Sân thượng"],
    openingHours: {
      monday: "7:00-22:00",
      tuesday: "7:00-22:00",
      wednesday: "7:00-22:00",
  ...
  {
    name: "Chói's Coffee & Tea",
    description: "Quán cafe độc đáo với view đẹp, đồ uống specialty coffee, bánh ngọt tự làm",
    category: LOCATION_CATEGORIES.CAFE,
    latitude: 21.015,
    longitude: 105.528,
    address: "Km29 Quốc lộ 21, Khu Công nghệ cao Hòa Lạc, Thạch Thất, Hà Nội",
    phone: "098 123 4567",
    imageUrl: "https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=800",
    amenities: ["Specialty coffee", "Bánh ngọt", "WiFi", "View đẹp"],
    openingHours: {
      monday: "8:00-22:00",
      tuesday: "8:00-22:00",
  ...
  {
    name: "Cộng Cà Phê - Hòa Lạc",
    description: "Không gian vintage, cafe phin đậm chất Việt, giá sinh viên",
    category: LOCATION_CATEGORIES.CAFE,
    latitude: 21.0135,
    longitude: 105.527,
    address: "Trung tâm thương mại Hòa Lạc, Khu Công nghệ cao Hòa Lạc, Thạch Thất",
    phone: "024 7300 8888",
    imageUrl: "https://images.unsplash.com/photo-1559496417-e7f25c7e7daf?w=800",
    amenities: ["Cafe phin", "Không gian ấm cúng", "Giá rẻ", "WiFi"],
    openingHours: {
      monday: "7:00-22:00",
      tuesday: "7:00-22:00",
      wednesday: "7:00-22:00",
  ...
  {
    name: "Highlands Coffee - Hòa Lạc",
    description: "Quán cafe chuỗi quen thuộc, view đẹp, phù hợp học nhóm",
    category: LOCATION_CATEGORIES.CAFE,
    latitude: 21.014,
    longitude: 105.529,
    ...
    amenities: ["WiFi", "Ổ cắm", "Không gian rộng", "Giá ổn"],
    openingHours: {
      monday: "7:00-22:30",
      tuesday: "7:00-22:30",
  ...
  // NHÀ HÀNG KHU VỰC HÒA LẠC
  {
    name: "Nhà hàng FPT - Canteen",
    description: "Nhà ăn đa dạng, giá sinh viên, đồ ăn Việt Nam và Á Âu",
    category: LOCATION_CATEGORIES.RESTAURANT,
    latitude: 21.0125,
    longitude: 105.5263,
    address: "Đại học FPT, Khu Công nghệ cao Hòa Lạc, Thạch Thất, Hà Nội",
    phone: "024 7300 2222",
    imageUrl: "https://images.unsplash.com/photo-1554679665-f5537aff554a?w=800",
    amenities: ["Đa dạng món", "Giá sinh viên", "Không gian rộng", "Phục vụ nhanh"],
    openingHours: {
      monday: "10:00-19:00",
      tuesday: "10:00-19:00",
  ...
  {
    name: "Bún Chả Việt - Hòa Lạc",
    description: "Bún chả truyền thống, nem nướng ngon, giá bình dân",
    category: LOCATION_CATEGORIES.RESTAURANT,
    latitude: 21.016,
    longitude: 105.5275,
    address: "Trung tâm thương mại Hòa Lạc, Thạch Thất, Hà Nội",
    phone: "098 765 1234",
    imageUrl: "https://images.unsplash.com/photo-1559054663-e8d23790bc51?w=800",
    amenities: ["Bún chả", "Nem nướng", "Giá rẻ", "Nước chấm ngon"],
    openingHours: {
      monday: "9:00-21:00",
      tuesday: "9:00-21:00",
  ...
  // QUÁN NET KHU VỰC HÒA LẠC
  {
    name: "Cyber Gaming - Hòa Lạc",
    description: "Phòng net cấu hình cao, đặc biệt cho sinh viên FPT, giá ưu đãi",
    category: LOCATION_CATEGORIES.INTERNET_CAFE,
    latitude: 21.0145,
    longitude: 105.5285,
    address: "Khu Công nghệ cao Hòa Lạc, Thạch Thất, Hà Nội",
    phone: "098 888 9999",
    imageUrl: "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800",
    amenities: ["RTX 4060", "144Hz", "Ghế gaming", "Đồ ăn nhanh", "Giá sinh viên"],
    openingHours: {
      monday: "24/7",
      tuesday: "24/7",
      wednesday: "24/7",
  ...
  // QUÁN GAME/PES KHU VỰC HÒA LẠC
  {
    name: "PES Zone - Hòa Lạc",
    description: "Chuyên PES, FIFA, tổ chức giải đấu FPT Arena hàng tuần",
    category: LOCATION_CATEGORIES.GAMING,
    latitude: 21.013,
    longitude: 105.5268,
    address: "Khu vực giải trí FPT, Khu Công nghệ cao Hòa Lạc",
    phone: "098 999 8888",
    imageUrl: "https://images.unsplash.com/photo-1511512578047-dfb367046420?w=800",
    amenities: ["PS5", "Xbox", "TV 4K", "Giải đấu tuần"],
    openingHours: {
      monday: "14:00-23:00",
      tuesday: "14:00-23:00",
  ...
  // WORKSHOP/COWORKING KHU VỰC HÒA LẠC
  {
    name: "FPT Coworking Space",
    description: "Không gian làm việc chung cho sinh viên, WiFi tốc độ cao, phòng họp miễn phí",
    category: LOCATION_CATEGORIES.WORKSHOP,
    latitude: 21.0126,
    longitude: 105.5264,
    address: "Tòa nhà A, Đại học FPT, Khu Công nghệ cao Hòa Lạc",
    phone: "024 7300 3333",
    imageUrl: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800",
    amenities: ["WiFi cao tốc", "Phòng họp", "Cafe", "Điều hòa"],
    openingHours: {
      monday: "8:00-22:00",
      tuesday: "8:00-22:00",
      wednesday: "8:00-22:00",
